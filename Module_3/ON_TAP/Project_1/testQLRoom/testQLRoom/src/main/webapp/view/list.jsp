...
<table class="table table-striped">
    ...
    <c:forEach var="rom" items="${roomList}" varStatus="status">
        <tr>
            <td>${status.count  + (pageNum -1) * pageSize}</td>
            ...
            <td>
                ...
                <button type="button" onclick="infoDelete('${rom.getIdRoom()}','${rom.getNameCustomer() }')"
                    ...
                    <div class="card-body">
                        <nav>
                            <ul class="pagination d-flex justify-content-center flex-wrap pagination-rounded-flat pagination-success">
                                ...
                                <c:forEach var="p" items="${range}">
                                    <li class="page-item"><a class="page-link" href="?pageNum=${p}"
                                                             data-abc="true">${p}</a></li>
                                </c:forEach>
                            </ul>
                        </nav>
                    </div>
