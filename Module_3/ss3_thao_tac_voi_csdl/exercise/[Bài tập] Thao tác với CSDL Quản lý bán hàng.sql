...
insert into customer value (1, 'Minh Quân' , 10) , (2, 'Ngọc Anh' , 20), (3, 'Hồng Hà' , 50);
...
select  customer.cName , `order` .oDate , ifnull(product.pName , 'huy don hang') as 'Sản Phẩm' from `order` 
